    ...
    <div class="header-wrapper row m-0">
      ...
      <div class="header-logo-wrapper col-auto p-0">
        ...
        <div class="logo-header-main"><a href="{{ route('dashboard') }}"><img class="img-fluid for-light"
              src="{{ asset('assets/images/logo/logo_minamaret.png') }}" alt=""><img class="img-fluid for-dark"
              src="{{ asset('assets/images/logo/logo_minamaret.png') }}" alt=""></a></div>
      </div>
        ...
        <div class="left-menu-header">
          ...
          <ul class="header-left">
            ...
            <li class="welcome-message" style="font-size: 16px;">
                ...
                |
                Role anda :<span style="font-weight: bold; color: #007bff;">
                     {{ session('user.role') }}
                </span>
            </li>
          </ul>
        ...
        <ul class="nav-menus">
          ...
          <li class="profile-nav onhover-dropdown">
            ...
            <ul class="profile-dropdown onhover-show-div">
              <li><a href="{{ route('edit_profile') }}"><i data-feather="settings"></i><span>Settings</span></a></li>
              <li>
