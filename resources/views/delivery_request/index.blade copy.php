    ...
    <form id="form-add-drs" class="modal-content">
      ...
      <div class="modal-body row g-3">
        ...
        <div class="col-md-3">
          ...
          <input type="text" name="delivery_note" class="form-control" placeholder="Delivery Note" readonly>
        </div>
        <div class="col-md-3">
...
$(document).ready(function() {
        ...
        columns: [
            ...
            { data: 'dn_no', defaultContent: '-' },            // DN Nomer
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `
                         ${badge}&nbsp;&nbsp;
                        <i class="fa fa-file-pdf-o text-danger fa-md" style="cursor:pointer;font-size:1.25em;" title="Download PDF" onclick="downloadDrsPdf(${data})"></i>&nbsp;&nbsp;
    ...
    function refreshDeliveryNote() {
        ...
        $.getJSON('/api/delivery-note-seq', { po: po_no, wilayah: wilayah })
            .done(function(res) {
...
window.ajukanPoSupplier = function(id) {
  ...
  if (!drsData) return alert("Data DRS tidak ditemukan!");
...
success: function(res) {
    ...
    error: function(xhr) {
      alert('Gagal mengajukan PO Supplier!\n' + (xhr.responseJSON?.message ?? ''));
    },
    complete: function() {
