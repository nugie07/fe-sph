...
<div class="modal fade" id="workflow-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Workflow History & Detail Pengajuan</h5>
                <button type="button" class="btn btn-danger rounded-square" style="border-radius:8px;" data-bs-dismiss="modal">
                    Tutup
                </button>
            </div>
            <div class="modal-body">
                <!-- Workflow History Section (Top) -->
                <div class="mb-4">
                    <h6 class="mb-3 fw-bold">Workflow History</h6>
                ...
                <!-- Detail Data Pengajuan Section -->
                <div class="mb-4">
                    <h6 class="mb-3 fw-bold">Detail Data Pengajuan</h6>
                    <div id="workflow-detail-supplier" style="display:none;">
                        <div class="row g-4">
                            <div class="col-md-4">
                                <label class="fw-bold">Nomer PO</label>
                                <input type="text" id="wf_vendor_po" class="form-control" readonly>
        </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Vendor Name</label>
                                <input type="text" id="wf_vendor_name" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Customer PO</label>
                                <input type="text" id="wf_customer_po" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Tanggal PO</label>
                                <input type="text" id="wf_tgl_po" class="form-control" readonly>
                            </div>
                            <div class="col-md-5">
                                <label class="fw-bold">Nama PIC</label>
                                <input type="text" id="wf_nama" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Contact</label>
                                <input type="text" id="wf_contact" class="form-control" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Alamat</label>
                                <input type="text" id="wf_alamat" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Metode Pembayaran</label>
                                <input type="text" id="wf_term" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">FOB</label>
                                <input type="text" id="wf_fob" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Shipped Via</label>
                                <input type="text" id="wf_shipped_via" class="form-control" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="fw-bold">Loading Point</label>
                                <input type="text" id="wf_loading_point" class="form-control" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="fw-bold">Delivery To</label>
                                <input type="text" id="wf_delivery_to" class="form-control" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="fw-bold">Harga</label>
                                <input type="text" id="wf_harga" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Qty</label>
                                <input type="text" id="wf_qty" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Sub Total</label>
                                <input type="text" id="wf_sub_total" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">PPN</label>
                                <input type="text" id="wf_ppn" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">PPH</label>
                                <input type="text" id="wf_pph" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">PBBKB</label>
                                <input type="text" id="wf_pbbkb" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">BPH</label>
                                <input type="text" id="wf_bph" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Total</label>
                                <input type="text" id="wf_total" class="form-control" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Terbilang</label>
                                <input type="text" id="wf_terbilang" class="form-control" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Keterangan</label>
                                <textarea id="wf_description" class="form-control" readonly></textarea>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Additional Notes</label>
                                <textarea id="wf_additional_notes" class="form-control" readonly></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="workflow-detail-transporter" style="display:none;">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="fw-bold">Customer PO</label>
                                <input type="text" id="wf_cp_customer_po" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Vendor PO</label>
                                <input type="text" id="wf_cp_vendor_po" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Tanggal PO</label>
                                <input type="text" id="wf_cp_tgl_po" class="form-control" readonly>
                            </div>
                            <div class="col-md-8">
                                <label class="fw-bold">Vendor Name</label>
                                <input type="text" id="wf_cp_vendor_name" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Tanggal PO</label>
                                <input type="text" id="wf_cp_tgl_po" class="form-control" readonly>
                            ...
                            <div class="col-md-6">
                                <label class="fw-bold">Nama PIC</label>
                                <input type="text" id="wf_cp_nama" class="form-control" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="fw-bold">Contact</label>
                                <input type="text" id="wf_cp_contact" class="form-control" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Alamat</label>
                                <input type="text" id="wf_cp_alamat" class="form-control" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Delivery To</label>
                                <input type="text" id="wf_cp_delivery_to" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">FOB</label>
                                <input type="text" id="wf_cp_fob" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Loading Point</label>
                                <input type="text" id="wf_cp_loading_point" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Shipped Via</label>
                                <input type="text" id="wf_cp_shipped_via" class="form-control" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Comments Or Special Notes</label>
                                <textarea id="wf_cp_special_notes" class="form-control" readonly></textarea>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Uang Portal</label>
                                <input type="text" id="wf_cp_portal" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Harga</label>
                                <input type="text" id="wf_cp_harga" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Qty</label>
                                <input type="text" id="wf_cp_qty" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Sub Total</label>
                                <input type="text" id="wf_cp_sub_total" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Total</label>
                                <input type="text" id="wf_cp_total" class="form-control" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="fw-bold">Metode Pembayaran</label>
                                <input type="text" id="wf_cp_term" class="form-control" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Terbilang</label>
                                <input type="text" id="wf_cp_terbilang" class="form-control" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Keterangan</label>
                                <textarea id="wf_cp_description" class="form-control" readonly></textarea>
                            </div>
                            <div class="col-md-12">
                                <label class="fw-bold">Additional Notes</label>
                                <textarea id="wf_cp_additional_notes" class="form-control" readonly></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
$('#modal-revisi-po-supplier').on('show.bs.modal', function() {
    ...
    $.when(poDataRequest, vendorListRequest).done(function(poDataResponse, vendorListResponse) {
        ...
        // Set tipe_sph jika ada
        if (d.tipe_sph) {
            $modal.find('#sp_tipe_sph').val(d.tipe_sph);
        } else {
            $modal.find('#sp_tipe_sph').val('');
        }
...
<style>
  ...
  /* Style for readonly fields in workflow modal */
  #workflow-modal input[readonly],
  #workflow-modal textarea[readonly] {
...
function calcSupplierFields() {
    ...
    console.log('Values:', {qty: qty, harga: harga, tipeSph: tipeSph}); // Debug log
...
$(document).ready(function(){
    ...
    // Helper function to create DataTable configuration
    function createDataTableConfig(tableId, filterStatusId, category) {
        // Determine column title based on category
        var vendorNameTitle = category == 2 ? 'Nama Vendor Transportir' : 'Nama Supplier';
        ...
        columns: [
            { data: 'no', className: 'text-center' },
                { data: 'vendor_po', className: 'text-center', title: 'Nomer PO' },
                { data: 'vendor_name', className: 'text-center', title: vendorNameTitle },
                { 
                    data: category == 2 ? 'qty' : 'total', 
                    className: 'text-end', 
                    title: category == 2 ? 'Qty / KL' : 'Nilai PO' 
                },
            {
                data: 'status',
    ...
    function loadSummary() {
      $.getJSON('/api/purchase-order/list', {
        status: $('#filter-status-supplier').val()
      }, function(res) {
    ...
    // Delegated event handlers for buttons inside DataTable (works for both tables)
    $(document).on('click', '#basic-1 tbody .btn-revisi-po, #basic-1-transportir tbody .btn-revisi-po', function(e) {
        e.preventDefault();
    ...
    $(document).on('click', '#basic-1 tbody .btn-create-po, #basic-1-transportir tbody .btn-create-po', function(e) {
        e.preventDefault();
        var id = $(this).data('id');
        if (!id) return;
    ...
    $(document).on('click', '#basic-1 tbody .status-click, #basic-1-transportir tbody .status-click', function() {
        var id = $(this).data('id');
        ...
        $('#workflow-detail-supplier').hide();
        $('#workflow-detail-transporter').hide();

        // Fetch workflow history and detail data in parallel
        var remarksRequest = $.get(`/api/remarks/${id}?tipe_trx=${tipe}`);
        var detailRequest = $.get('/api/purchase-order/list', { id: id });

        $.when(remarksRequest, detailRequest).done(function(remarksRes, detailRes) {
            // Populate workflow history
            var list = Array.isArray(remarksRes[0]) ? remarksRes[0] : (remarksRes[0].data || []);
            ...
            var detailData = (detailRes[0].data && detailRes[0].data[0]) || {};
            
            if (cat == 1) {
                // Supplier PO
                $('#workflow-detail-supplier').show();
                $('#wf_vendor_po').val(detailData.vendor_po || '');
                $('#wf_vendor_name').val(detailData.vendor_name || '');
                $('#wf_customer_po').val(detailData.customer_po || '');
                $('#wf_tgl_po').val(detailData.tgl_po || '');
                $('#wf_nama').val(detailData.nama || '');
                $('#wf_contact').val(detailData.contact || '');
                $('#wf_alamat').val(detailData.alamat || '');
                $('#wf_term').val(detailData.term || '');
                $('#wf_fob').val(detailData.fob || '');
                $('#wf_shipped_via').val(detailData.shipped_via || '');
                $('#wf_loading_point').val(detailData.loading_point || '');
                $('#wf_delivery_to').val(detailData.delivery_to || '');
                $('#wf_harga').val(detailData.harga ? formatRupiah(detailData.harga) : '');
                $('#wf_qty').val(detailData.qty || '');
                $('#wf_sub_total').val(detailData.sub_total ? formatRupiah(detailData.sub_total) : '');
                $('#wf_ppn').val(detailData.ppn ? formatRupiah(detailData.ppn) : '');
                $('#wf_pph').val(detailData.pph ? formatRupiah(detailData.pph) : '');
                $('#wf_pbbkb').val(detailData.pbbkb ? formatRupiah(detailData.pbbkb) : '');
                $('#wf_bph').val(detailData.bph ? formatRupiah(detailData.bph) : '');
                $('#wf_total').val(detailData.total ? formatRupiah(detailData.total) : '');
                $('#wf_terbilang').val(detailData.terbilang || '');
                $('#wf_description').val(detailData.description || '');
                $('#wf_additional_notes').val(detailData.additional_notes || '');
            } else {
                // Transporter PO
                $('#workflow-detail-transporter').show();
                $('#wf_cp_customer_po').val(detailData.customer_po || '');
                $('#wf_cp_vendor_po').val(detailData.vendor_po || '');
                $('#wf_cp_vendor_name').val(detailData.vendor_name || '');
                $('#wf_cp_tgl_po').val(detailData.tgl_po || '');
                $('#wf_cp_nama').val(detailData.pic_site || detailData.nama || '');
                $('#wf_cp_contact').val(detailData.pic_site_telp || detailData.contact || '');
                $('#wf_cp_alamat').val(detailData.site_location || detailData.alamat || '');
                $('#wf_cp_delivery_to').val(detailData.delivery_to || '');
                $('#wf_cp_fob').val(detailData.fob || '');
                $('#wf_cp_loading_point').val(detailData.loading_point || '');
                $('#wf_cp_shipped_via').val(detailData.shipped_via || '');
                $('#wf_cp_special_notes').val(detailData.special_notes || '');
                $('#wf_cp_portal').val(detailData.portal ? formatRupiah(detailData.portal) : '');
                $('#wf_cp_harga').val(detailData.harga ? formatRupiah(detailData.harga) : '');
                $('#wf_cp_qty').val(detailData.qty || '');
                $('#wf_cp_sub_total').val(detailData.sub_total ? formatRupiah(detailData.sub_total) : '');
                $('#wf_cp_total').val(detailData.total ? formatRupiah(detailData.total) : '');
                $('#wf_cp_term').val(detailData.term || '');
                $('#wf_cp_terbilang').val(detailData.terbilang || '');
                $('#wf_cp_description').val(detailData.description || '');
                $('#wf_cp_additional_notes').val(detailData.additional_notes || '');
            }
        }).fail(function(xhr) {
            console.error('Error loading workflow data:', xhr);
    ...
    $('#btnAddPOSupplier').on('click', function(e) {
        e.preventDefault();
        // Redirect ke halaman create PO supplier
        window.location.href = '{{ route("purchase_order.create_supplier") }}';
    });

    // --- Create PO Transportir Modal Logic ---
    $('#btnAddPOTransportir').on('click', function(e) {
        e.preventDefault();
        // Redirect ke halaman create PO transportir
        window.location.href = '{{ route("purchase_order.create_transportir") }}';
    });
    ...
    $('#modal-create-po-supplier #sp_harga').on('input', function(){
    ...
    handleFormSubmit('#form-revisi-transportir', '#btn-save-revisi-transportir', '/api/purchase-order', 'PUT');
        ...
        // Handle PDF icon click (works for both tables)
    $(document).on('click', '.pdf-icon', function(e) {
        ...
        var tableInstance = $table.attr('id') === 'basic-1-transportir' ? tableTransportir : table;

        // Get the row data
        var row = tableInstance.row($row).data();
        if (row && row.file) {
