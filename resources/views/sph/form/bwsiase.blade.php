                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered align-middle" id="table-oat-lines-kencana">
                      ...
                      <tbody>
                        ...
                        <tr data-customer="PT Alamraya Kencana Mas" data-qty="5">
                          <td rowspan="2" style="vertical-align: middle;">PT Alamraya Kencana Mas                          </td>
                          ...
                          <td rowspan="2" style="vertical-align: middle;">Kalimantan Selatan</td>
                        </tr>
                        <tr data-customer="PT Alamraya Kencana Mas" data-qty="10">
...
<script>
    $(document).ready(function() {
        ...
        (function autoGenerateKode(){
            ...
            if (passedCompanyId) {
                $.get('/api/get-customer-detail', { id: passedCompanyId }, function(data) {
                    ...
                    var pct = parsePbbkbFromResponse(data.pbbkb);
                    $('#table-oat-lines-kencana').data('pbbkb-percentage', pct);
                    $('#table-oat-lines-kencana tbody tr').each(function(){ recalcRow($(this)); });
                });
            }
        })();
        ...
        // Parse PBBKB % dari response get-customer-detail (e.g. "7.5%" atau 7.5)
        function parsePbbkbFromResponse(val) {
        ...
        function recalcRow($row){
            ...
            try {
                ...
                // Fallback: PBBKB % dari response get-customer-detail (untuk form dengan lokasi fix)
                if (!lokasiPercentage) {
                    const stored = $('#table-oat-lines-kencana').data('pbbkb-percentage');
                    if (stored != null && stored !== '') lokasiPercentage = parseFloat(stored) || 0;
                }
            } catch (err) {
        ...
        $('#comp_name').on('change', function() {
            ...
            } else { $('#susut').val(''); $('#table-oat-lines-kencana').removeData('pbbkb-percentage'); }
        });
        ...
        $('#sph-form').on('submit', function(e) {
            ...
            $('#table-oat-lines-kencana tbody tr').each(function(){
                ...
                if (!lokasiText && $customerGroup.length) lokasiText = $customerGroup.first().find('td:last').text().trim() || 'Kalimantan Selatan';
